...
const index_1 = require("../../../../codegen/crm/exports/index");
...
const rxjsStub_1 = require("../../../../codegen/crm/exports/rxjsStub");
class ExportsDiscovery {
    constructor(config) {
        ...
        this.publicExportsApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.PublicExportsApi(configuration));
    }
}
exports.default = ExportsDiscovery;
//# sourceMappingURL=ExportsDiscovery.js.map