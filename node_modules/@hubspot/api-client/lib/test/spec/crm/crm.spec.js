...
const CommerceDiscovery_1 = __importDefault(require("../../../src/discovery/crm/commerce/CommerceDiscovery"));
...
const ExportsDiscovery_1 = __importDefault(require("../../../src/discovery/crm/exports/ExportsDiscovery"));
...
describe('api client', () => {
    it('is discoverable', () => {
        ...
        expect(CommerceDiscovery_1.default.name).toBe(client.commerce.constructor.name);
        ...
        expect(ExportsDiscovery_1.default.name).toBe(client.exports.constructor.name);
