...
export declare class BasicApiRequestFactory extends BaseAPIRequestFactory {
    archive(invoiceId: string, _options?: Configuration): Promise<RequestContext>;
    create(simplePublicObjectInputForCreate: SimplePublicObjectInputForCreate, _options?: Configuration): Promise<RequestContext>;
    getById(invoiceId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Promise<RequestContext>;
    ...
    update(invoiceId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Promise<RequestContext>;
}
