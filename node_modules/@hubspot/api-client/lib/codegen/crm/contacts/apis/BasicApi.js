    ...
    getById(contactId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (propertiesWithHistory !== undefined) {
                const serializedParams = ObjectSerializer_1.ObjectSerializer.serialize(propertiesWithHistory, "Array<string>", "");
                for (const serializedParam of serializedParams) {
                    requestContext.appendQueryParam("propertiesWithHistory", serializedParam);
                }
            }
            if (associations !== undefined) {
                const serializedParams = ObjectSerializer_1.ObjectSerializer.serialize(associations, "Array<string>", "");
                for (const serializedParam of serializedParams) {
    ...
    merge(publicMergeInput, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (publicMergeInput === null || publicMergeInput === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "merge", "publicMergeInput");
            }
    ...
    purge(publicGdprDeleteInput, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (publicGdprDeleteInput === null || publicGdprDeleteInput === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "purge", "publicGdprDeleteInput");
            }
