...
export declare class ObjectBasicApi {
    ...
    createWithHttpInfo(param: BasicApiCreateRequest, options?: ConfigurationOptions): Promise<HttpInfo<SimplePublicObject>>;
    create(param: BasicApiCreateRequest, options?: ConfigurationOptions): Promise<SimplePublicObject>;
    ...
    mergeWithHttpInfo(param: BasicApiMergeRequest, options?: ConfigurationOptions): Promise<HttpInfo<SimplePublicObject>>;
    merge(param: BasicApiMergeRequest, options?: ConfigurationOptions): Promise<SimplePublicObject>;
    purgeWithHttpInfo(param: BasicApiPurgeRequest, options?: ConfigurationOptions): Promise<HttpInfo<void>>;
    purge(param: BasicApiPurgeRequest, options?: ConfigurationOptions): Promise<void>;
    updateWithHttpInfo(param: BasicApiUpdateRequest, options?: ConfigurationOptions): Promise<HttpInfo<SimplePublicObject>>;
    update(param: BasicApiUpdateRequest, options?: ConfigurationOptions): Promise<SimplePublicObject>;
}
...
export declare class ObjectBatchApi {
    ...
    createWithHttpInfo(param: BatchApiCreateRequest, options?: ConfigurationOptions): Promise<HttpInfo<BatchResponseSimplePublicObject | BatchResponseSimplePublicObjectWithErrors>>;
    create(param: BatchApiCreateRequest, options?: ConfigurationOptions): Promise<BatchResponseSimplePublicObject | BatchResponseSimplePublicObjectWithErrors>;
    ...
    updateWithHttpInfo(param: BatchApiUpdateRequest, options?: ConfigurationOptions): Promise<HttpInfo<BatchResponseSimplePublicObject | BatchResponseSimplePublicObjectWithErrors>>;
    update(param: BatchApiUpdateRequest, options?: ConfigurationOptions): Promise<BatchResponseSimplePublicObject | BatchResponseSimplePublicObjectWithErrors>;
    upsertWithHttpInfo(param: BatchApiUpsertRequest, options?: ConfigurationOptions): Promise<HttpInfo<BatchResponseSimplePublicUpsertObjectWithErrors | BatchResponseSimplePublicUpsertObject>>;
    upsert(param: BatchApiUpsertRequest, options?: ConfigurationOptions): Promise<BatchResponseSimplePublicUpsertObjectWithErrors | BatchResponseSimplePublicUpsertObject>;
}
