...
export declare class ObservableBusinessUnitApi {
    ...
    getByUserIDWithHttpInfo(userId: string, properties?: Array<string>, name?: Array<string>, _options?: ConfigurationOptions): Observable<HttpInfo<CollectionResponsePublicBusinessUnitNoPaging>>;
    getByUserID(userId: string, properties?: Array<string>, name?: Array<string>, _options?: ConfigurationOptions): Observable<CollectionResponsePublicBusinessUnitNoPaging>;
}
