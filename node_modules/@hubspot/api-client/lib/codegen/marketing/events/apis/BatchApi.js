    ...
    archiveByObjectId(batchInputMarketingEventPublicObjectIdDeleteRequest, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (batchInputMarketingEventPublicObjectIdDeleteRequest === null || batchInputMarketingEventPublicObjectIdDeleteRequest === undefined) {
                throw new baseapi_1.RequiredError("BatchApi", "archiveByObjectId", "batchInputMarketingEventPublicObjectIdDeleteRequest");
            }
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(batchInputMarketingEventPublicObjectIdDeleteRequest, "BatchInputMarketingEventPublicObjectIdDeleteRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            let authMethod;
            authMethod = _config.authMethods["oauth2"];
            if (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication) {
    ...
    updateByObjectId(batchInputMarketingEventPublicUpdateRequestFullV2, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (batchInputMarketingEventPublicUpdateRequestFullV2 === null || batchInputMarketingEventPublicUpdateRequestFullV2 === undefined) {
                throw new baseapi_1.RequiredError("BatchApi", "updateByObjectId", "batchInputMarketingEventPublicUpdateRequestFullV2");
            }
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(batchInputMarketingEventPublicUpdateRequestFullV2, "BatchInputMarketingEventPublicUpdateRequestFullV2", ""), contentType);
            requestContext.setBody(serializedBody);
            let authMethod;
            authMethod = _config.authMethods["oauth2"];
            if (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication) {
    ...
    upsert(batchInputMarketingEventCreateRequestParams, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (batchInputMarketingEventCreateRequestParams === null || batchInputMarketingEventCreateRequestParams === undefined) {
                throw new baseapi_1.RequiredError("BatchApi", "upsert", "batchInputMarketingEventCreateRequestParams");
            }
...
class BatchApiResponseProcessor {
    ...
    archiveByObjectIdWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    ...
    updateByObjectIdWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "BatchResponseMarketingEventPublicDefaultResponseV2", "");
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, body);
            }
            if ((0, util_1.isCodeInRange)("207", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "BatchResponseMarketingEventPublicDefaultResponseV2WithErrors", "");
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, body);
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
            ...
            if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "BatchResponseMarketingEventPublicDefaultResponseV2WithErrors | BatchResponseMarketingEventPublicDefaultResponseV2", "");
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, body);
            }
            throw new exception_1.ApiException(response.httpStatusCode, "Unknown API Status Code!", yield response.getBodyAsAny(), response.headers);
        });
