...
class BatchApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(batchInputString, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (batchInputString === null || batchInputString === undefined) {
                throw new baseapi_1.RequiredError("BatchApi", "archive", "batchInputString");
            }
    ...
    create(batchInputBlogPost, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (batchInputBlogPost === null || batchInputBlogPost === undefined) {
                throw new baseapi_1.RequiredError("BatchApi", "create", "batchInputBlogPost");
            }
    ...
    read(batchInputString, archived, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (batchInputString === null || batchInputString === undefined) {
                throw new baseapi_1.RequiredError("BatchApi", "read", "batchInputString");
            }
    ...
    update(batchInputJsonNode, archived, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (batchInputJsonNode === null || batchInputJsonNode === undefined) {
                throw new baseapi_1.RequiredError("BatchApi", "update", "batchInputJsonNode");
            }
