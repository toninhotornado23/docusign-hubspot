...
export declare class ObservablePublicApi {
    ...
    getByIdWithHttpInfo(contentId: string, type?: 'LANDING_PAGE' | 'BLOG_POST' | 'SITE_PAGE' | 'KNOWLEDGE_ARTICLE' | 'LISTING_PAGE', _options?: ConfigurationOptions): Observable<HttpInfo<IndexedData>>;
    getById(contentId: string, type?: 'LANDING_PAGE' | 'BLOG_POST' | 'SITE_PAGE' | 'KNOWLEDGE_ARTICLE' | 'LISTING_PAGE', _options?: ConfigurationOptions): Observable<IndexedData>;
