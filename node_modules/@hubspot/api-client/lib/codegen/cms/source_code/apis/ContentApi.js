    ...
    downloadWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((0, util_1.isCodeInRange)("403", response.httpStatusCode)) {
                throw new exception_1.ApiException(response.httpStatusCode, "Insufficient permissions to access the file", undefined, response.headers);
            }
            if ((0, util_1.isCodeInRange)("404", response.httpStatusCode)) {
                throw new exception_1.ApiException(response.httpStatusCode, "File not found at the specified path", undefined, response.headers);
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
